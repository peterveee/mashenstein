// THE DOGS AS THEY WERE (gallery-only). A verbatim copy of the quadruped rig the
// three lane dogs and the finish guard wore until 24 Sep 2026, lifted out of
// sprites/animals.js when the dogs bake-off's B (CLEAN LINE, sprites/dogs.js)
// replaced them — so the bake-off's card A can still show what was there. The cat
// still wears the original in animals.js; nothing in the game imports this file.
// --------------------------------------------------------------- primitives
