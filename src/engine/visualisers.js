...
class ArcadeArtGallery extends BaseVisualiser {
  constructor(seed, track) {
    ...
    const heroIds = ['lorenzo', 'rusty', 'fernwick', 'b33p', 'clara', 'kiko', 'ramon', 'grumpos'];
...
// These are not per-pixel, but are whole scenes with enough layered geometry
// that it is not cheap to paint both sides during a transition.
