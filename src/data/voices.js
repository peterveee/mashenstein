...
const TONE = {
  ...
  snareTrash: { label: 'Trash Snare', category: 'Snare', synth: 'MetalSynth', dur: 1.4,
    ...
    options: { harmonicity: 6.4, modulationIndex: 40, resonance: 1200, octaves: 2,
      envelope: { attack: 0.001, decay: 0.3, release: 0.2 } } },
  snareFlam: { label: 'Flam Snare', category: 'Snare', synth: 'MetalSynth', dur: 1,
  ...
  clapMetal: { label: 'Metal Clap', category: 'Clap', synth: 'MetalSynth', dur: 1,
  ...
  clapFm: { label: 'FM Clap', category: 'Clap', synth: 'FMSynth', dur: 1,
  ...
  buzzRoll: { label: 'Buzz Roll', category: 'Perc', synth: 'MetalSynth', dur: 1,
...
const LEVELS = {
  ...
  dsRim: 0.018473, vl1Pi: 0.014004, vl1Po: 0.014353, vl1Sha: 0.034957,
  dsZap: 0.056003, rimRing: 0.005348, rimWood: 0.004971, rimClang: 0.047909,
  hatCluster: 0.01563, hatClusterOpen: 0.055057, snarePink: 0.026481,
  clapHands: 0.011519, kickCrush: 0.032487, kickEngine: 0.03437,
  kickShop: 0.030652, kickMegamix: 0.029193, snareEngine: 0.015394,
  clapEngine: 0.052286, hatEngine: 0.02664, ohatEngine: 0.056556,
  tomEngine: 0.036372, rimEngine: 0.032346, crashEngine: 0.077097,
  crashFinale: 0.06291, dsCrackSnare2: 0.101559, dsClosedHat2: 0.090277,
  engineCrash: 0.246364, ds909Kick: 0.058672, ds909KickPunch: 0.059112,
  ds909Snare: 0.129815, ds909SnareCrack: 0.063039, ds909Clap: 0.011164,
  ds909Hat: 0.028418, ds909OpenHat: 0.080241, ds909Tom: 0.049216,
  ...
  ds808Snare: 0.026153, ds808Clap: 0.014409, ds808Hat: 0.01638,
  ds808OpenHat: 0.056353, ds808Cowbell: 0.028111, ds808Tom: 0.055444,
  amHollow2: 0.01455, stKickPunch: 0.030431, stSnareCrisp: 0.01243,
  stHatTick: 0.024818, stRoundMono: 0.075557, stFmKeys: 0.021576,
  stMonoBright: 0.087427, stKickDeep: 0.068639, stSnareBrush: 0.034296,
  stTaiko: 0.026424, stSubSine: 0.11677, stReedOrgan: 0.027077,
  stVibratoLead: 0.183201, stKickTight: 0.029608, stSnareRim: 0.008436,
  stClave: 0.006432, stTpBassGuitar: 0.085495, stClav: 0.005047,
  stSynthPluck: 0.028111, stKickThud: 0.027204, stSnareFat: 0.018183,
  stHatPedal: 0.007613, stDsRim: 0.018473, stRubberBass: 0.056514,
  stEpiano: 0.023667, stCeleste: 0.024454, stHatClosed: 0.013707,
  stHatOpen: 0.056805, stDetuneBass: 0.161441, stWarmPad: 0.104127,
  stDuoDetune: 0.114131, stWoodBlock: 0.008281, stTriangleDing: 0.149995,
  stGlassPad: 0.021327, stMusicBox: 0.020825, stSnareFlam: 0.180881,
  stSynthStrings: 0.148374, stReedLead: 0.114797, stHatSizzle: 0.049903,
  stFmGrowl: 0.023982, stAmOrgan: 0.026762, stGlassLead: 0.020582,
  stClapRoom: 0.027297, stTpBassy: 0.097032, stTpPianoetta: 0.111126,
  stTpBah: 0.005703, stKickDirty: 0.054799, stClapTight: 0.006178,
  stMetalHatClosed: 0.03987, stCowbell: 0.121817, stAcidSquelch: 0.06367,
  stBreathPad: 0.119482, stTpLectric: 0.031326, stKickClick: 0.048943,
  stClap808: 0.010142, stDsHatClosed: 0.015363, stZap: 0.023577,
  stPadTriangle: 0.101497, stFmBell: 0.018029, stAmHollow: 0.01455,
  sawtoothTone2: 0.011265, sintone: 0.02496, bigRoomClap: 0.019534,
  vl1Pi2: 0.040498
};
...
const PEAKS = {
  ...
  vl1Pi: 1.0879, vl1Po: 0.6836, vl1Sha: 0.8505, dsZap: 0.7, rimRing: 0.371,
  rimWood: 0.1411, rimClang: 0.7, hatCluster: 0.8142, hatClusterOpen: 1.0755,
  snarePink: 0.7266, clapHands: 0.2871, kickCrush: 0.6934, kickEngine: 0.7966,
  ...
  sawtoothTone2: 0.4101, sintone: 0.6553, bigRoomClap: 0.3628, vl1Pi2: 1.4428
};
...
const STARTER = {
  ...
  stSnareFlam: { label: 'Flam Snare (starter)', category: 'Snare', kind: 'tone', synth: 'MetalSynth', dur: 1,
