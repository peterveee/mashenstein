...
export const mix = {
  ...
  lanes: {
    kick: { gain: -1, send: { delay: 0.28 } },
    clap: { gain: -1, send: { delay: 0.28 } },
    bass: { send: { delay: 0.28 } },
    lead: { send: { delay: 0.28 } },
    leadHarm: { send: { delay: 0.28 } },
    chords: { send: { delay: 0.28 } },
    keyGliss: { send: { delay: 0.28 } },
    gliss: { send: { delay: 0.28 } },
    vox: { send: { delay: 0.28 } },
    shout: { send: { delay: 0.28 } },
    snare: { send: { delay: 0.28 } },
    hats: { send: { delay: 0.28 } },
    ohats: { send: { delay: 0.28 } },
  },
};
