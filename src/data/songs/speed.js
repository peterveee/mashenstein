...
export const mix = {
  ...
  lanes: {
    ...
    lead2: { gain: -18.9, send: { delay: 0.69, reverb: 3 } },
    ...
    bass2: { gain: -4.6, effects: [{ id: "compressor", params: { ratio: 7.5 } }], noteFx: {"strum":{"enabled":false,"direction":"up","gapMs":18},"arp":{"enabled":true,"direction":"updown","rate":1,"octaves":2,"limit":3,"rangeLimit":false,"rangeLo":48,"rangeHi":72,"repeat":true,"gate":80,"retrigger":"chord","latch":true}} },
...
export const variants = {
  select: [
    {
      when: "always",
      loop: { fromBar: 3, toBar: 3 },
      patch: {
        masterEffects: [{ id: "gain" }, { id: "filter", params: { type: "highpass", Q: 0.1 } }, { id: "phaser", params: { frequency: 0.122, octaves: 3.1, feedback: 0.6, baseFrequency: 323.25, wet: 1 } }, { id: "doubler", bypass: true, params: { depth: 0.66, delayMs: 27, wet: 0.52 } }],
        lanes: {
          kick: { mute: true },
          snare: { mute: true },
          clap: { mute: true },
      ...
      exit: { quantize: "beat", crossfadeBars: 0, loopRelease: "immediate" },
    },
  ],
};
