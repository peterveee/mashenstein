...
export const mix = {
  ...
  lanes: {
    ...
    bass: { gain: -4.3, effects: [{ id: "compressor", params: { ratio: 7.5 } }] },
...
export const variants = {
  select: [
    {
      when: "always",
      loop: { fromBar: 1, toBar: 1 },
      treatment: [{ id: "widener" }, { id: "autofilter", params: { rateSync: 1, rateDivision: 32, octaves: 4, baseFrequency: 685.876 } }, { id: "reverb", params: { preDelay: 0.013, decay: 2.4, wet: 0.42 } }],
      patch: {
        lanes: {
          lead: { gain: -9.6 },
          kick: { gain: -12.2, mute: true },
          snare: { mute: true },
          clap: { mute: true },
          bass: { mute: true },
          hats2: { gain: -7.4 },
      ...
      exit: { quantize: "beat", crossfadeBars: 0, loopRelease: "atTransition", treatBars: 0.5 },
    },
  ],
};
