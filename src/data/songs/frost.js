...
export const mix = {
  ...
  lanes: {
    ...
    lead2: { gain: -12.1, send: { reverb: 0.789 }, effects: [{ id: "pingpong" }] },
    ...
    lead8: { gain: -5.8, eq: { low: -9.6, mid: 5.7, high: 7.1 }, effects: [{ id: "autopanner", params: { rateDivision: 32 } }] },
  },
};
