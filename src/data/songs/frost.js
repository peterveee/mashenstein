...
export const mix = {
  ...
  lanes: {
    ...
    lead8: { gain: -9.4, send: { delay: 0.822 }, eq: { low: -9.6, mid: 5.7, high: 7.1 }, effects: [{ id: "autopanner", params: { rateDivision: 32 } }] },
  },
};
