...
export const mix = {
  layers: [{ key: "snare2", from: "snare", independent: true, label: "=808 Snare" }, { key: "lead3", from: "lead" }],
...
export const variants = {
  select: [
    {
      when: "always",
      loop: { fromBar: 8, toBar: 8 },
      patch: {
        lanes: {
          clap: { send: { delay: 0.08, reverb: 2.269 }, effects: [{ id: "reverb", params: { wet: 0.67 } }, { id: "doubler", params: { delayMs: 11 } }] },
          hats: { mute: true },
          bass: { mute: true },
          snare2: { mute: true },
        },
