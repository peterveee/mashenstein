...
export const mix = {
  master: -2.3,
  voice: {"kickVoice":"kickShop","snareVoice":"snareEngine","clapVoice":"clapEngine","hatsVoice":"hatEngine"},
  lanes: {
    kick: { gain: -6 },
    hats: { gain: -6 },
    clap: { gain: -6 },
    lead: { send: { delay: 0.2 } },
    leadHarm: { send: { delay: 0.2 } },
    twinkle: { send: { delay: 0.2 } },
    chords: { send: { delay: 0.2 } },
    organChords: { send: { delay: 0.2 } },
    organGliss: { send: { delay: 0.2 } },
    organSwoop: { send: { delay: 0.2 } },
  },
};
