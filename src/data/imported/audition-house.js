// HOUSE AUDITION — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "audition-house";
export const title = "HOUSE AUDITION";
export const slug = "audition-house";
