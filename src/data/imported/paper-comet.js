// PAPER COMET — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "paper-comet";
export const title = "PAPER COMET";
export const slug = "paper-comet";
export const group = "scratch";
export const seed = 3223181777;
