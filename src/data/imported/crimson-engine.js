// CRIMSON ENGINE — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "crimson-engine";
export const title = "CRIMSON ENGINE";
export const slug = "crimson-engine";
export const group = "scratch";
export const seed = 2708166622;
