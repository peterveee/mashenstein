// SESERAGI v9 SYNDRUM — one song: what it plays, how it is arranged, how it sounds.
//
...
// 
// VERSION 9 — v8e (the breakdown lift repeats bars 47–48 in E♭ minor, no
// transpose, dropping a semitone into D minor at bar 53) plus an occasional
// high syndrum pew (Synare Long Pew on the tom lane) through a distant
// dotted-eighth ping-pong: one off-beat hit every four to eight bars, dark half
// and breakdown only.
// 
...
// for the outro.
// 
// Written by work/local/_seseragi-v9.mjs through tools/lib/song-source.js — the
...
export const id = "seseragi-v9-syndrum";
export const title = "SESERAGI v9 SYNDRUM";
export const slug = "seseragi-v9-syndrum";
