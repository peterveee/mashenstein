// SESERAGI v7 SHIBUYA MAJOR LIFT — one song: what it plays, how it is arranged, how it sounds.
//
...
// 
// VERSION 7 — the LIFT in D MAJOR: minor, minor, minor, major, and bar 53 flips
// to D minor on the same root.
// 
...
// for the outro.
// 
// Written by work/local/_seseragi-v7.mjs through tools/lib/song-source.js — the
...
export const id = "seseragi-v7-shibuya-major-lift";
export const title = "SESERAGI v7 SHIBUYA MAJOR LIFT";
export const slug = "seseragi-v7-shibuya-major-lift";
...
export const bank = {
  ...
  sections: [
    ...
    {
      lead: seq('C#5 . A4 . F#4 . E4 . E4 . D4 . A3 . D4 . | . . C#5 . D5 . C#5 . D5 . C#5 . A4 . F#4 .'),
      lead6: seq('C#5 . A4 . F#4 . E4 . E4 . D4 . A3 . D4 . | . . C#5 . D5 . C#5 . D5 . C#5 . A4 . F#4 .'),
      lead3: seq('C#4 . A3 . F#3 . E3 . E3 . D3 . A2 . D3 . | . . C#4 . D4 . C#4 . D4 . C#4 . A3 . F#3 .'),
      lead4: seq('D3 . A3 . F#4 . A3 . D3 . A3 . F#4 . A3 . | D3 . A3 . F#4 . A3 . D3 . A3 . F#4 . A3 .'),
      chords2: chordSeq('D4 . . . . . . . . . . . . . . . | D4 . . . . . . . . . . . . . . .'),
      chords2Len: [16,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,16,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],
