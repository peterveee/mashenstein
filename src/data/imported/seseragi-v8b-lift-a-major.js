// SESERAGI v8b LIFT A MAJOR — one song: what it plays, how it is arranged, how it sounds.
//
...
// 
// VERSION 8b — the LIFT in A MAJOR, the dominant: minor, minor, minor, major,
// and the strongest pull into bar 53 — V to i, with the melody ending on C#, the
// leading tone of D.
// 
...
// for the outro.
// 
// Written by work/local/_seseragi-v8b.mjs through tools/lib/song-source.js — the
...
export const id = "seseragi-v8b-lift-a-major";
export const title = "SESERAGI v8b LIFT A MAJOR";
export const slug = "seseragi-v8b-lift-a-major";
...
export const bank = {
  ...
  sections: [
    ...
    {
      lead: seq('G#5 . E5 . C#5 . B4 . B4 . A4 . E4 . A4 . | . . G#5 . A5 . G#5 . A5 . G#5 . E5 . C#5 .'),
      lead6: seq('G#5 . E5 . C#5 . B4 . B4 . A4 . E4 . A4 . | . . G#5 . A5 . G#5 . A5 . G#5 . E5 . C#5 .'),
      lead3: seq('G#4 . E4 . C#4 . B3 . B3 . A3 . E3 . A3 . | . . G#4 . A4 . G#4 . A4 . G#4 . E4 . C#4 .'),
      lead4: seq('A2 . E3 . C#4 . E3 . A2 . E3 . C#4 . E3 . | A2 . E3 . C#4 . E3 . A2 . E3 . C#4 . E3 .'),
      chords2: chordSeq('A3 . . . . . . . . . . . . . . . | A3 . . . . . . . . . . . . . . .'),
      chords2Len: [16,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,16,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],
      bass2: seq('A2 A2 A3 A2 A2 A2 A3 A2 A2 A2 A3 A2 A2 A2 A3 A2 | A2 A2 A3 A2 A2 A2 A3 A2 A2 A2 A3 A2 A2 A2 A3 A2'),
      hats: seq('C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 | C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1').map((v) => !!v),
      kick: seq('. . . . . . . . . . . . . . . . | C1 . . . C1 . . . C1 . . . C1 . . .').map((v) => !!v),
