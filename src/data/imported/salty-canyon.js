// SALTY CANYON — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "salty-canyon";
export const title = "SALTY CANYON";
export const slug = "salty-canyon";
export const group = "scratch";
export const seed = 4102367917;
  ...
  sections: [
    {
      ...
      bass: seq('A2 . A2 . A2 . A2 A2 A2 . A2 . A2 . A2 A2 | A2 . A2 . A2 . A2 A2 A2 . A2 . A2 . A2 A2'),
      chords: chordSeq('A3min . . . . . . . . . . . . . . . | A3min . . . . . . . . . . . . . . .'),
      lead: seq('E5 . . . . . . . . . . . C5 . . . | A4 . . . . . . . . . . . B4 . . .'),
    },
  ],
  order: [0,0,0,0],
};
