// ELECTRIC BEETLE — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "electric-beetle";
export const title = "ELECTRIC BEETLE";
export const slug = "electric-beetle";
export const group = "scratch";
export const seed = 1490873209;
  ...
  sections: [
    {
      ...
      lead: seq('E5 D5 C5 B4 A4 . B4 . C5 . D5 . E5 . F5 . | G#5 A5 G#5 F5 E5 . D5 . C5 . B4 . A4 . A4 .'),
    },
  ],
  order: [0],
};
