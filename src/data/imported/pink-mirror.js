// PINK MIRROR — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "pink-mirror";
export const title = "PINK MIRROR";
export const slug = "pink-mirror";
export const group = "scratch";
export const seed = 3556130216;
