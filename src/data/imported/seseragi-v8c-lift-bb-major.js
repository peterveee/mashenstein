// SESERAGI v8c LIFT Bb MAJOR — one song: what it plays, how it is arranged, how it sounds.
//
...
// 
// VERSION 8c — the LIFT in B♭ MAJOR, the flat sixth: minor, minor, minor, major,
// and the cinematic landing — ♭VI to i, the melody ending on D, the tonic of the
// bar it lands in.
// 
...
// for the outro.
// 
// Written by work/local/_seseragi-v8c.mjs through tools/lib/song-source.js — the
...
export const id = "seseragi-v8c-lift-bb-major";
export const title = "SESERAGI v8c LIFT Bb MAJOR";
export const slug = "seseragi-v8c-lift-bb-major";
...
export const bank = {
  ...
  sections: [
    ...
    {
      lead: seq('A5 . F5 . D5 . C5 . C5 . A#4 . F4 . A#4 . | . . A5 . A#5 . A5 . A#5 . A5 . F5 . D5 .'),
      lead6: seq('A5 . F5 . D5 . C5 . C5 . A#4 . F4 . A#4 . | . . A5 . A#5 . A5 . A#5 . A5 . F5 . D5 .'),
      lead3: seq('A4 . F4 . D4 . C4 . C4 . A#3 . F3 . A#3 . | . . A4 . A#4 . A4 . A#4 . A4 . F4 . D4 .'),
      lead4: seq('A#2 . F3 . D4 . F3 . A#2 . F3 . D4 . F3 . | A#2 . F3 . D4 . F3 . A#2 . F3 . D4 . F3 .'),
      chords2: chordSeq('A#3 . . . . . . . . . . . . . . . | A#3 . . . . . . . . . . . . . . .'),
      chords2Len: [16,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,16,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],
      bass2: seq('A#1 A#1 A#2 A#1 A#1 A#1 A#2 A#1 A#1 A#1 A#2 A#1 A#1 A#1 A#2 A#1 | A#1 A#1 A#2 A#1 A#1 A#1 A#2 A#1 A#1 A#1 A#2 A#1 A#1 A#1 A#2 A#1'),
      hats: seq('C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 | C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1').map((v) => !!v),
      kick: seq('. . . . . . . . . . . . . . . . | C1 . . . C1 . . . C1 . . . C1 . . .').map((v) => !!v),
