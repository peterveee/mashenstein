// HAPPY LADDER — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "happy-ladder";
export const title = "HAPPY LADDER";
export const slug = "happy-ladder";
export const group = "scratch";
export const seed = 3965811321;
