// SESERAGI v8a LIFT F MAJOR — one song: what it plays, how it is arranged, how it sounds.
//
...
// 
// VERSION 8a — the LIFT in F MAJOR, the relative major: minor, minor, minor,
// major, and the smoothest landing of the variations — the lift ends on A, which
// is the pedal note bar 53 starts on.
// 
...
// for the outro.
// 
// Written by work/local/_seseragi-v8a.mjs through tools/lib/song-source.js — the
...
export const id = "seseragi-v8a-lift-f-major";
export const title = "SESERAGI v8a LIFT F MAJOR";
export const slug = "seseragi-v8a-lift-f-major";
...
export const bank = {
  ...
  sections: [
    ...
    {
      lead: seq('E5 . C5 . A4 . G4 . G4 . F4 . C4 . F4 . | . . E5 . F5 . E5 . F5 . E5 . C5 . A4 .'),
      lead6: seq('E5 . C5 . A4 . G4 . G4 . F4 . C4 . F4 . | . . E5 . F5 . E5 . F5 . E5 . C5 . A4 .'),
      lead3: seq('E4 . C4 . A3 . G3 . G3 . F3 . C3 . F3 . | . . E4 . F4 . E4 . F4 . E4 . C4 . A3 .'),
      lead4: seq('F2 . C3 . A3 . C3 . F2 . C3 . A3 . C3 . | F2 . C3 . A3 . C3 . F2 . C3 . A3 . C3 .'),
      chords2: chordSeq('F3 . . . . . . . . . . . . . . . | F3 . . . . . . . . . . . . . . .'),
      chords2Len: [16,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,16,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],
      bass2: seq('F1 F1 F2 F1 F1 F1 F2 F1 F1 F1 F2 F1 F1 F1 F2 F1 | F1 F1 F2 F1 F1 F1 F2 F1 F1 F1 F2 F1 F1 F1 F2 F1'),
      hats: seq('C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 | C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1').map((v) => !!v),
      kick: seq('. . . . . . . . . . . . . . . . | C1 . . . C1 . . . C1 . . . C1 . . .').map((v) => !!v),
