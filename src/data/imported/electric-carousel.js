// ELECTRIC CAROUSEL — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "electric-carousel";
export const title = "ELECTRIC CAROUSEL";
export const slug = "electric-carousel";
export const group = "scratch";
export const seed = 3416539391;
  ...
  sections: [
    {
      ...
      lead: seq('. . G5 . D#5 . . C5 . . D#5 . G5 . . . | . . A5 . G5 . . D#5 . . C5 . D5 . . .'),
    },
  ],
  order: [0],
};
