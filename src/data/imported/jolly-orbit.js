// JOLLY ORBIT — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "jolly-orbit";
export const title = "JOLLY ORBIT";
export const slug = "jolly-orbit";
export const group = "scratch";
export const seed = 810205094;
