// FROZEN SCOOTER — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "frozen-scooter";
export const title = "FROZEN SCOOTER";
export const slug = "frozen-scooter";
export const group = "scratch";
export const seed = 2640368162;
  ...
  sections: [
    {
      ...
      chords: chordSeq('C3min . . . . . . . A#3 . . . . . . . | G#3 . . . . . . . G3 . . . . . . .'),
      lead: seq('C5 . . . C5 . D#5 . G5 . . . G#5 . G5 . | D#5 . . . C5 . G5 . D#5 . . . C5 . D#5 .'),
    },
  ],
  order: [0],
};
