// NEW THE FOOD COURT — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "new-the-food-court";
export const title = "NEW THE FOOD COURT";
export const slug = "new-the-food-court";
...
export const mix = {
  ...
  voice: {"kickVoice":"kickEngine","snareVoice":"snareEngine","clapVoice":"clapEngine","hatsVoice":"hatEngine","ohatsVoice":"ohatEngine","crash2Voice":"crashFinale","bassVoice":"bestPwmBass","leadVoice":"squareMono","chordsVoice":"bestPwmClav","leadHarmVoice":"squareMono"},
  ...
  lanes: {
    ...
    keyGliss: { gain: 2.5, send: { delay: 0.03, reverb: 1.084 }, eq: { low: -1.8, high: 3.3 }, effects: [{ id: "bitcrusher", bypass: true, params: { bits: 4, drive: 4, tone: 3945.696, wet: 0.55 } }, { id: "autopanner", params: { rateSync: 1, depth: 0.71, rateDivision: 0.5 } }, { id: "pingpong", bypass: true, params: { wet: 0.34, feedback: 0.21 } }] },
    ...
    hats: { gain: 0.6, pan: -0.336, send: { delay: 0.28, reverb: 0.006 }, effects: [{ id: "exciter", params: { timbre: 0.41, mix: 0.7, tune: 1847.725, drive: 0.7 } }] },
    ohats: { pan: -0.313, send: { delay: 0.28, reverb: 0.018 } },
