...
export const mix = {
  ...
  lanes: {
    ...
    keyGliss: { gain: 2.5, send: { delay: 0.03, reverb: 1.084 }, eq: { low: -1.8, high: 3.3 }, effects: [{ id: "bitcrusher", bypass: true, params: { bits: 4, downsample: 12, wet: 0.55 } }, { id: "autopanner", params: { rateSync: 1, depth: 0.71, rateDivision: 0.5 } }, { id: "pingpong", bypass: true, params: { wet: 0.34, feedback: 0.21 } }] },
