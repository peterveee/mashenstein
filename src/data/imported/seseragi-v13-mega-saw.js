// SESERAGI v13 MEGA SAW — one song: what it plays, how it is arranged, how it sounds.
//
...
// 
// VERSION 13 — the dark lead moved off the sync razor (a mono voice that choked
// on eighths at 150 — the minor jingle was never really heard) onto the mega saw,
// set just under the Tron bass; the arpeggio pluck down 3 dB and both basses
// down 2. Pews on the downbeats of bars 21, 45 and 53; the breakdown lift
// repeats bars 47–48 in E♭ minor.
// 
...
// home. From there it is dark: the minor figure on a mega-saw lead over an ostinato,
...
// strings and an 80s bass for the bright opening; a mega-saw lead, crystal
...
// for the outro.
// 
// Written by work/local/_seseragi-v13.mjs through tools/lib/song-source.js — the
...
export const id = "seseragi-v13-mega-saw";
export const title = "SESERAGI v13 MEGA SAW";
export const slug = "seseragi-v13-mega-saw";
...
export const mix = {
  ...
  labels: {"lead":"CHIME Ice Bell","twinkle":"OCTAVES Alloy Chime","lead2":"KOTO","chords":"PAD Warm Strings","bass":"BASS 80s","lead3":"DARK LEAD Mega Saw","lead4":"OSTINATO Crystal","lead5":"BRASS Stabs","bass2":"BASS Tron Pulse","chords2":"DARK PAD Burnt Horizon","lead6":"SHIBUYA DOUBLE Neon Reed","tom":"SYNDRUM Pew"},
  voice: {"leadVoice":"tngrIceBell","twinkleVoice":"tngrAlloyChime","lead2Voice":"koto","chordsVoice":"tngrWarmStrings","bassVoice":"bass80sSynth","lead3Voice":"bestMegaSawLead","lead4Voice":"tngrCrystalTrigger","lead5Voice":"tngrBrassSection","lead6Voice":"tngrNeonReed","bass2Voice":"tngrNightSequence","chords2Voice":"tngrBurntHorizon","tomVoice":"syn3PewLong","kickVoice":"kickMegamix","snareVoice":"ds909Snare","clapVoice":"clapEngine","hatsVoice":"hatEngine","ohatsVoice":"ohat909SixBit","crashVoice":"crashEngine","sweepsVoice":"sweepUp"},
  lanes: {
    ...
    bass: { gain: -5 },
    lead3: { send: { delay: 0.18, reverb: 0.3 } },
    lead4: { gain: -6, pan: 0.35, send: { delay: 0.25, reverb: 0.2 } },
