// BITTER MARKET — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "bitter-market";
export const title = "BITTER MARKET";
export const slug = "bitter-market";
export const group = "scratch";
export const seed = 2035038472;
  ...
  sections: [
    {
      ...
      bass: seq('G2 . . . . . . . C3 . . . . . . . | F2 . . . . . . . G2 . . . . . . .'),
      chords: chordSeq('G3min . . . G3min . . . C3min . . . C3min . . . | F3 . . . F3 . . . G3min . . . G3min . . .'),
      lead: seq('G4 . G4 . A#4 . . D5 D#5 . D5 . A#4 . . G4 | D5 . A#4 . G4 . . A#4 C5 . A#4 . G4 . . G4'),
    },
  ],
  order: [0,0,0,0],
};
