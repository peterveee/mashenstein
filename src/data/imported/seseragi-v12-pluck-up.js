// SESERAGI v12 PLUCK UP — one song: what it plays, how it is arranged, how it sounds.
//
...
// 
// VERSION 12 — v11 (Tron bass level with the opening bass) with the arpeggio
// pluck up 6 dB and the syndrum pews up 8. The pluck is ducked 10 dB in the
// breakdown so the Shibuya melody stays on top. Pews on the downbeats of bars
// 21, 45 and 53; the breakdown lift repeats bars 47–48 in E♭ minor.
// 
...
// for the outro.
// 
// Written by work/local/_seseragi-v12.mjs through tools/lib/song-source.js — the
...
export const id = "seseragi-v12-pluck-up";
export const title = "SESERAGI v12 PLUCK UP";
export const slug = "seseragi-v12-pluck-up";
...
export const mix = {
  ...
  lanes: {
    ...
    lead4: { gain: -3, pan: 0.35, send: { delay: 0.25, reverb: 0.2 } },
    lead5: { gain: -8, pan: -0.15, send: { reverb: 0.3 } },
    lead6: { gain: 2, pan: 0.12, send: { delay: 0.12, reverb: 0.35 } },
    bass2: { gain: -3 },
    chords2: { gain: -11, send: { reverb: 0.45 } },
    tom: { gain: -3, pan: 0.25, send: { reverb: 0.7 }, eq: { low: -6 }, effects: [{ id: "pingpong", params: { sync: 1, division: 0.75, feedback: 0.55, wet: 0.5 } }] },
