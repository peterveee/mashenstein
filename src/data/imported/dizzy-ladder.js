// DIZZY LADDER — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "dizzy-ladder";
export const title = "DIZZY LADDER";
export const slug = "dizzy-ladder";
export const group = "scratch";
export const seed = 341274115;
