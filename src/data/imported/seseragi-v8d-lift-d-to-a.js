// SESERAGI v8d LIFT D TO A — one song: what it plays, how it is arranged, how it sounds.
//
...
// 
// VERSION 8d — the LIFT in D MAJOR for bar 51, then the dominant, A major, for
// bar 52: minor, minor, minor, major, and a turnaround that pushes into bar 53 —
// the brightness of v7 with a V chord in front of the landing. The melody's
// second bar is re-voiced over A (E in place of D).
// 
...
// in E♭ minor, bars 1–2 again with the razor lead and Tron bass back, then bars
...
// for the outro.
// 
// Written by work/local/_seseragi-v8d.mjs through tools/lib/song-source.js — the
...
export const id = "seseragi-v8d-lift-d-to-a";
export const title = "SESERAGI v8d LIFT D TO A";
export const slug = "seseragi-v8d-lift-d-to-a";
...
export const bank = {
  ...
  sections: [
    ...
    {
      lead: seq('C#5 . A4 . F#4 . E4 . E4 . D4 . A3 . D4 . | . . C#5 . E5 . C#5 . E5 . C#5 . A4 . E4 .'),
      lead6: seq('C#5 . A4 . F#4 . E4 . E4 . D4 . A3 . D4 . | . . C#5 . E5 . C#5 . E5 . C#5 . A4 . E4 .'),
      lead3: seq('C#4 . A3 . F#3 . E3 . E3 . D3 . A2 . D3 . | . . C#4 . E4 . C#4 . E4 . C#4 . A3 . E3 .'),
      lead4: seq('D3 . A3 . F#4 . A3 . D3 . A3 . F#4 . A3 . | A2 . E3 . C#4 . E3 . A2 . E3 . C#4 . E3 .'),
      chords2: chordSeq('D4 . . . . . . . . . . . . . . . | A3 . . . . . . . . . . . . . . .'),
      chords2Len: [16,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,16,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],
      bass2: seq('D2 D2 D3 D2 D2 D2 D3 D2 D2 D2 D3 D2 D2 D2 D3 D2 | A2 A2 A3 A2 A2 A2 A3 A2 A2 A2 A3 A2 A2 A2 A3 A2'),
      hats: seq('C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 | C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1').map((v) => !!v),
      kick: seq('. . . . . . . . . . . . . . . . | C1 . . . C1 . . . C1 . . . C1 . . .').map((v) => !!v),
...
export const mix = {
  ...
  labels: {"lead":"CHIME Ice Bell","twinkle":"OCTAVES Alloy Chime","lead2":"KOTO","chords":"PAD Warm Strings","bass":"BASS 80s","lead3":"DARK LEAD Razor","lead4":"OSTINATO Crystal","lead5":"BRASS Stabs","bass2":"BASS Tron Pulse","chords2":"DARK PAD Burnt Horizon","lead6":"SHIBUYA DOUBLE Neon Reed"},
  voice: {"leadVoice":"tngrIceBell","twinkleVoice":"tngrAlloyChime","lead2Voice":"koto","chordsVoice":"tngrWarmStrings","bassVoice":"bass80sSynth","lead3Voice":"syncRazorLead","lead4Voice":"tngrCrystalTrigger","lead5Voice":"tngrBrassSection","lead6Voice":"tngrNeonReed","bass2Voice":"tngrNightSequence","chords2Voice":"tngrBurntHorizon","kickVoice":"kickMegamix","snareVoice":"ds909Snare","clapVoice":"clapEngine","hatsVoice":"hatEngine","ohatsVoice":"ohat909SixBit","crashVoice":"crashEngine","sweepsVoice":"sweepUp"},
  lanes: {
    ...
    lead6: { gain: 2, pan: 0.12, send: { delay: 0.12, reverb: 0.35 } },
    bass2: { gain: -10 },
