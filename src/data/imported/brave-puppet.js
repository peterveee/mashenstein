// BRAVE PUPPET — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "brave-puppet";
export const title = "BRAVE PUPPET";
export const slug = "brave-puppet";
export const group = "scratch";
export const seed = 3707565146;
