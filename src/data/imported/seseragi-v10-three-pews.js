// SESERAGI v10 THREE PEWS — one song: what it plays, how it is arranged, how it sounds.
//
...
// 
// VERSION 10 — v8e (the breakdown lift repeats bars 47–48 in E♭ minor, no
// transpose, dropping a semitone into D minor at bar 53) plus a high syndrum
// pew (Synare Long Pew on the tom lane) through a distant dotted-eighth
// ping-pong — three times only, each on a new section's downbeat: bar 21 (the
// first dark section), bar 45 (the breakdown) and bar 53 (the return).
// 
...
// for the outro.
// 
// Written by work/local/_seseragi-v10.mjs through tools/lib/song-source.js — the
...
export const id = "seseragi-v10-three-pews";
export const title = "SESERAGI v10 THREE PEWS";
export const slug = "seseragi-v10-three-pews";
...
export const mix = {
  ...
  labels: {"lead":"CHIME Ice Bell","twinkle":"OCTAVES Alloy Chime","lead2":"KOTO","chords":"PAD Warm Strings","bass":"BASS 80s","lead3":"DARK LEAD Razor","lead4":"OSTINATO Crystal","lead5":"BRASS Stabs","bass2":"BASS Tron Pulse","chords2":"DARK PAD Burnt Horizon","lead6":"SHIBUYA DOUBLE Neon Reed","tom":"SYNDRUM Pew"},
  voice: {"leadVoice":"tngrIceBell","twinkleVoice":"tngrAlloyChime","lead2Voice":"koto","chordsVoice":"tngrWarmStrings","bassVoice":"bass80sSynth","lead3Voice":"syncRazorLead","lead4Voice":"tngrCrystalTrigger","lead5Voice":"tngrBrassSection","lead6Voice":"tngrNeonReed","bass2Voice":"tngrNightSequence","chords2Voice":"tngrBurntHorizon","tomVoice":"syn3PewLong","kickVoice":"kickMegamix","snareVoice":"ds909Snare","clapVoice":"clapEngine","hatsVoice":"hatEngine","ohatsVoice":"ohat909SixBit","crashVoice":"crashEngine","sweepsVoice":"sweepUp"},
  lanes: {
    ...
    tom: { gain: -11, pan: 0.25, send: { reverb: 0.7 }, eq: { low: -6 }, effects: [{ id: "pingpong", params: { sync: 1, division: 0.75, feedback: 0.55, wet: 0.5 } }] },
