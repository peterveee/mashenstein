// ROYAL HARBOUR — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "royal-harbour";
export const title = "ROYAL HARBOUR";
export const slug = "royal-harbour";
export const group = "scratch";
export const seed = 503722222;
