// SESERAGI v8e LIFT NO TRANSPOSE — one song: what it plays, how it is arranged, how it sounds.
//
...
// 
// VERSION 8e — NO TRANSPOSE: bars 51–52 are bars 47–48 again, in E♭ minor, with
// the razor lead, Tron bass, snare roll and riser on top. E♭ minor then drops a
// semitone into D minor at bar 53 — ♭II to i, the darkest of the landings.
// 
...
// for the outro.
// 
// Written by work/local/_seseragi-v8e.mjs through tools/lib/song-source.js — the
...
export const id = "seseragi-v8e-lift-no-transpose";
export const title = "SESERAGI v8e LIFT NO TRANSPOSE";
export const slug = "seseragi-v8e-lift-no-transpose";
