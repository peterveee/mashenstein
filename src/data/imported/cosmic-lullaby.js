...
export const mix = {
  layers: [{ key: "tom2", from: "tom", independent: true, label: "= 808 Hat" }, { key: "tom3", from: "tom", independent: true, label: "= 808 Open Hat" }, { key: "tom4", from: "tom", independent: true, label: "= Grit Hat" }, { key: "tom5", from: "tom", independent: true, label: "= Grit Open Hat" }, { key: "tom6", from: "tom", independent: true, label: "= Foil Hat" }, { key: "tom7", from: "tom", independent: true, label: "= Foil Open Hat" }, { key: "tom8", from: "tom", independent: true, label: "= Snap Hat" }, { key: "tom9", from: "tom", independent: true, label: "= Snap Open Hat" }],
  off: ["lead"],
