// SALTY TEMPLE — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "salty-temple";
export const title = "SALTY TEMPLE";
export const slug = "salty-temple";
export const group = "scratch";
export const seed = 2151537845;
  ...
  sections: [
    {
      ...
      bass: seq('D3 . . . . . . . F2 . . . . . . . | A#2 . . . . . . . C3 . . . . . . .'),
      chords: chordSeq('D3min . . . D3min . . . F3 . . . F3 . . . | A#3 . . . A#3 . . . C3 . . . C3 . . .'),
      lead: seq('D5 . . . F5 . A5 . A#5 . . . A5 . F5 . | E5 . . . F5 . A5 . A#5 . . . D6 . A#5 .'),
    },
  ],
  order: [0],
};
