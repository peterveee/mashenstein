...
export const mix = {
  ...
  lanes: {
    ...
    hats: { gain: -1.8, pan: -0.13, send: { delay: 0.28 }, eq: { high: 4.9 } },
    ohats: { gain: -8.6, pan: -0.179, send: { delay: 0.28 } },
    crash2: { gain: -18 },
    bass: { pan: -0.314, eq: { high: -3.5 } },
  },
};
