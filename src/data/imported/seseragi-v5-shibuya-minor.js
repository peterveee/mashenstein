// SESERAGI v5 SHIBUYA MINOR — one song: what it plays, how it is arranged, how it sounds.
//
...
// 
// VERSION 5: v3 with the breakdown (bars 45–52) rebuilt around the SHIBUYA
// melody from work/tracks/shibuya3.mid — moved to start on C, bars 1–2 in C minor,
// bars 3–4 in E♭ MINOR (v4 had them major — too hopeful), its rolled chord
// landing on F#maj7, then the build on G.
// 
...
// for the outro.
// 
// Written by work/local/_seseragi-v5.mjs through tools/lib/song-source.js — the
...
export const id = "seseragi-v5-shibuya-minor";
export const title = "SESERAGI v5 SHIBUYA MINOR";
export const slug = "seseragi-v5-shibuya-minor";
