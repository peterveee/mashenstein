// GLASS GARDEN — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "glass-garden";
export const title = "GLASS GARDEN";
export const slug = "glass-garden";
export const group = "scratch";
export const seed = 2867065147;
  ...
  sections: [
    {
      ...
      bass: seq('A2 . . . A3 . . . C3 . . . C4 . . . | F2 . . . F3 . . . G2 . . . G3 . . .'),
      chords: chordSeq('A3min . . A3min . . A3min . C3 . . C3 . . C3 . | F3 . . F3 . . F3 . G3 . . G3 . . G3 .'),
      lead: seq('A4 . C5 . E5 . . C5 A4 . C5 . F5 . . E5 | A4 . C5 . D5 . . F5 E5 . D5 . C5 . . A4'),
    },
  ],
  order: [0],
};
