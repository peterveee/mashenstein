// WILD PARADE — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "wild-parade";
export const title = "WILD PARADE";
export const slug = "wild-parade";
export const group = "scratch";
export const seed = 228990062;
