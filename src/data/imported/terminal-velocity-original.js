// TERMINAL VELOCITY (ORIGINAL) — the neon cabinet's song until 23 Sep 2026, when
// SESERAGI v17 replaced it. Kept here, desk-only, so it can still be heard and
// mixed.
//
...
export const id = "terminal-velocity-original";
export const title = "TERMINAL VELOCITY (ORIGINAL)";
export const slug = "terminal-velocity-original";
