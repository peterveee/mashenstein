// CHROME DOLPHIN — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "chrome-dolphin";
export const title = "CHROME DOLPHIN";
export const slug = "chrome-dolphin";
export const group = "scratch";
export const seed = 1388970541;
