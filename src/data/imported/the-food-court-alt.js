...
export const mix = {
  master: 1.1,
  masterEffects: [{ id: "mbComp" }, { id: "mbComp" }],
  ...
  lanes: {
    ...
    chords: { gain: -14.8, send: { delay: 0.094, reverb: 0.051 }, eq: { high: 3.1 }, effects: [{ id: "doubler", params: { delayMs: 11, depth: 0.11, dryPan: -0.72, wetPan: 0.52, wet: 0.33 } }, { id: "reverb", params: { wet: 0.19 } }] },
    keyGliss: { gain: 2.8, send: { delay: 0.03, reverb: 1.084 }, eq: { low: -1.8, high: 3.3 }, effects: [{ id: "bitcrusher", bypass: true, params: { bits: 4, drive: 4, tone: 3945.696, wet: 0.55 } }, { id: "autopanner", params: { rateSync: 1, depth: 0.71, rateDivision: 0.5 } }, { id: "pingpong", bypass: true, params: { wet: 0.34, feedback: 0.21 } }] },
    ...
    snare: { gain: 0.7, send: { delay: 0.117, reverb: 0.176 }, eq: { mid: 2.5, high: 1.8 } },
    hats: { gain: -3.6, pan: -0.458, send: { delay: 0.28, reverb: 0.006 }, effects: [{ id: "exciter", params: { timbre: 0.41, mix: 0.7, tune: 1847.725, drive: 0.7 } }] },
