// SESERAGI v3 DARK — one song: what it plays, how it is arranged, how it sounds.
//
...
// for the outro.
// 
// Written by work/local/_seseragi-v3.mjs through tools/lib/song-source.js — the
...
export const id = "seseragi-v3-dark";
export const title = "SESERAGI v3 DARK";
export const slug = "seseragi-v3-dark";
...
export const bank = {
  ...
  sections: [
    ...
    },
    {
      ...
      lead4: seq('D#5 . C5 . A#4 . G#4 . A#4 . C5 . D#5 . C5 . | C5 . A#4 . C5 . D5 . F5 . D5 . C5 . A#4 .'),
      chords2: chordSeq('G#3 . . . . . . . . . . . . . . . | A#3 . . . . . . . . . . . . . . .'),
      chords2Len: [16,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,16,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],
      hats: seq('C1 . C1 . C1 . C1 . C1 . C1 . C1 . C1 . | C1 . C1 . C1 . C1 . C1 . C1 . C1 . C1 .').map((v) => !!v),
    },
    {
