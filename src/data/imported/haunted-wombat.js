// HAUNTED WOMBAT — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "haunted-wombat";
export const title = "HAUNTED WOMBAT";
export const slug = "haunted-wombat";
export const group = "scratch";
export const seed = 4149259260;
