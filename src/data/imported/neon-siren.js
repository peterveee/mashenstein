// NEON SIREN — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "neon-siren";
export const title = "NEON SIREN";
export const slug = "neon-siren";
export const group = "scratch";
export const seed = 2547221634;
  ...
  sections: [
    {
      ...
      bass: seq('D3 . . . . . . . G2 . . . . . . . | C3 . . . . . . . D3 . . . . . . .'),
      chords: chordSeq('D3min . . . D3min . . . G3min . . . G3min . . . | C3 . . . C3 . . . D3min . . . D3min . . .'),
      lead: seq('D5 . F5 . A5 . F5 . D5 . F5 . A#5 . A5 . | D5 . F5 . G5 . A#5 . A5 . G5 . F5 . D5 .'),
    },
  ],
  order: [0,0,0,0],
};
