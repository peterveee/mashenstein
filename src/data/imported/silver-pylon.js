// SILVER PYLON — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "silver-pylon";
export const title = "SILVER PYLON";
export const slug = "silver-pylon";
export const group = "scratch";
export const seed = 2498093826;
  ...
  sections: [
    {
      ...
      bass: seq('C3 . . . C4 . . . D#3 . . . D#4 . . . | G#2 . . . G#3 . . . A#2 . . . A#3 . . .'),
      chords: chordSeq('C3min . . . . . . . D#3 . . . . . . . | G#3 . . . . . . . A#3 . . . . . . .'),
      lead: seq('C5 . . . D#5 . G5 . G#5 . . . G5 . D#5 . | D5 . . . D#5 . G5 . G#5 . . . C6 . G#5 .'),
    },
  ],
  order: [0],
};
