// SESERAGI v6 SHIBUYA LIFT — one song: what it plays, how it is arranged, how it sounds.
//
...
// 
// VERSION 6: v3 with the breakdown (bars 45–52) rebuilt around the SHIBUYA
// melody from work/tracks/shibuya3.mid — moved to start on C, bars 1–2 in C minor,
// bars 3–4 in E♭ MINOR (v4 had them major — too hopeful), then bars 1–2 again,
// then bars 3–4 again a whole step up in D MINOR under the snare roll, so bar 53
// lands in the new key already home (v5 used the file's rolled chord there and
// it did not work). The melody is doubled on a neon reed so it carries.
// 
...
// for the outro.
// 
// Written by work/local/_seseragi-v6.mjs through tools/lib/song-source.js — the
...
export const id = "seseragi-v6-shibuya-lift";
export const title = "SESERAGI v6 SHIBUYA LIFT";
export const slug = "seseragi-v6-shibuya-lift";
...
export const bank = {
  ...
  sections: [
    ...
    {
      lead: seq('C#5 . A4 . F4 . E4 . E4 . D4 . A3 . D4 . | . . C#5 . D5 . C#5 . D5 . C#5 . A4 . F4 .'),
      lead6: seq('C#5 . A4 . F4 . E4 . E4 . D4 . A3 . D4 . | . . C#5 . D5 . C#5 . D5 . C#5 . A4 . F4 .'),
      lead3: seq('C#4 . A3 . F3 . E3 . E3 . D3 . A2 . D3 . | . . C#4 . D4 . C#4 . D4 . C#4 . A3 . F3 .'),
      lead4: seq('D3 . A3 . F4 . A3 . D3 . A3 . F4 . A3 . | D3 . A3 . F4 . A3 . D3 . A3 . F4 . A3 .'),
      chords2: chordSeq('D4min . . . . . . . . . . . . . . . | D4min . . . . . . . . . . . . . . .'),
      chords2Len: [16,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,16,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],
      bass2: seq('D2 D2 D3 D2 D2 D2 D3 D2 D2 D2 D3 D2 D2 D2 D3 D2 | D2 D2 D3 D2 D2 D2 D3 D2 D2 D2 D3 D2 D2 D2 D3 D2'),
      hats: seq('C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 | C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1 C1').map((v) => !!v),
      kick: seq('. . . . . . . . . . . . . . . . | C1 . . . C1 . . . C1 . . . C1 . . .').map((v) => !!v),
