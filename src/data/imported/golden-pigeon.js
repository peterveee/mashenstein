// GOLDEN PIGEON — one song: what it plays, how it is arranged, how it sounds.
//
...
export const id = "golden-pigeon";
export const title = "GOLDEN PIGEON";
export const slug = "golden-pigeon";
export const group = "scratch";
export const seed = 3178367763;
