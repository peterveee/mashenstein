// Render only the requested organ-backed alternatives, leaving the original
// six audition WAVs untouched for direct A/B comparison.
import { mkdirSync } from 'fs';
import { spawnSync } from 'child_process';
import { dirname, join } from 'path';
import { fileURLToPath } from 'url';
import { SHOP_THEME_ORGAN_VARIANTS } from '../src/data/shop-themes.js';
