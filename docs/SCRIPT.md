...
| TERMINAL VELOCITY | [ENTER]: AUTHORIZE VECTOR DESTRUCTION |
...
|---|---|---|
| 1 | REACH THE FINISH LINE. HIT IT. SAVE EVERYTHING. | COLLECT 20 COINS |
...
| 2 | BONK THE CLOWN-COPTER FROM BELOW, 3 TIMES. IT IS UNDERINSURED. | COLLECT 25 COINS |
...
| Stage | Mission | Challenge |
|---|---|---|
| 1 | RUN TO THE BEAT. OR NEAR THE BEAT. THE BEAT IS FLEXIBLE. | 30 ON-BEAT ACTIONS |
| 2 | SURVIVE THE CHORUS. THE BAND IS IN DEBT. | GET A 10 COMBO |
...
| 3 | BONK THE COPTER 3 TIMES. IT IS HELD UP BY A VISIBLE HAND. | COLLECT 35 COINS |
...
|---|---|
| **B-33P** | PEW |
| **CLARA** | SHE FIRED. TWICE. / SHE FIRED. GENEROUSLY. *(charged)* |
