...
5. **Clara Vault** — CLARA VAULT, MALL RAIDER. A raider-archaeologist (Tomb Raider parody) who narrates herself as the heroine of a pulp adventure serial — breathless third person, past tense, chapter numbers — while standing in a food court. The narrator is always sincere; the gap between the prose and the premises is the joke. Skill: Cliffhanger (one huge jump, 15% higher). Ability: PLOT HOLE — both pistols, a double-tap pair of slugs. Full brief: [docs/notes/clara-persona.md](notes/clara-persona.md). *(She took Mochi's slot; the pink puffball who only says "POYO" is retired from the roster, held for a cameo like Miss Chomp.)*
6. **Kiko** — KIKO, JURISDICTION PENDING. A martial artist conducting a criminal investigation nobody authorised, in a privately-owned building where her badge means nothing (street-fighter parody). She came for a tournament the blackout cancelled and stayed for the felony. Skill: Foot Pursuit (jumps twice). Ability: WARNING SHOT. Her one bit is JURISDICTION, and it is kept to *criminal* procedure — warrant, custody, evidence, scene, rights, suspect, canvass, prints — so she never blurs into Gary's HR paperwork or Ray M'n's insurance forms. Full brief: [docs/notes/kiko-persona.md](notes/kiko-persona.md).
...
- **Miss Chomp** — retired from the relay when Kiko took her roster slot. Regal, food-court-obsessed glutton (Pac-Man parody, but with legs). **She is not in the game right now**: she no longer runs, and she has been taken out of the food court she used to stand in at the serving line, so neither the roll call nor the credits crawl bills her any more (Kiko took over her FACILITIES → HUMAN RESOURCES handoff — Gary cannot introduce a department that is mostly a joke at his expense, and she has no standing there at all, which is her bit). She is held for a possible **cameo elsewhere** later. Everything she needs is intact and unused — her cast card in [src/game/cast.js](src/game/cast.js), her ten `HUB_LINES` in [src/data/jokes.js](src/data/jokes.js), her `disc` rig and painter in [src/sprites/toons.js](src/sprites/toons.js) — so bringing her back is a placement, not a rebuild.
...
- **Unnamed roles**: "cabinet residents" (generic escortable NPCs), zombies (a palette-swapped reuse of Gary's sprite, functioning as a hazard not a character).
