...
That's the complete named roster per the game's own script doc — eight heroes, one villain, and two real NPCs (Gary, Dust Devil), everything else is unnamed set dressing.
