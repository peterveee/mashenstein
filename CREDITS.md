...
*(The screen dims. A single power LED blinks awake in the corner. The crawl begins.)*

---

**A CIRCUIT & SPLICE INTERACTIVE PRODUCTION**
**IN ASSOCIATION WITH RECLAIMED PARTS STUDIOS**
*a division of General Appliance Holdings, Unincorporated*

---

## DIRECTION

Creative Director — **Adrienne Castellan**
Game Director — **Marcus Oyelaran**
Executive Producer — **Priya Deshbandhu**
Studio Head / General Manager — **Walter Krebbs**
...
Lead Producer — **Simone Achterberg**
Associate Producer — **Devon Iyer**
Associate Producer — **Bea Whitlock**
Associate Producer — **Toma Radu**
Production Coordinator — **Nkechi Obuya**
Line Producer, Budget Cuts Division — **Herb Yun** *(also responsible)*

---

## DESIGN

Design Director — **Callum Reyes-Pratt**
Lead Gameplay Designer — **Odalys Ferreira**
Relay & Portal Systems Design — **Jonas Whitfield**
Plugs Economy Design — **Rosalind Achebe**
Boss Encounter Design — **Yusuf Okonkwo-Bright**
Breaker-Box Minigame Design — **Liesel Thorncombe**
Difficulty & Fairness Design, Modes One Through Four — **Parminder Josh**
...
CARDBOARD KINGDOM — **Rhiannon Oduya**
CORPORATE KOMBAT — **Felix Bramante**
THE SURGE — **the entire Design department, simultaneously, against best practice**

---

## NARRATIVE

Narrative Director — **Esme Vantongeren**
Lead Writer — **Duncan Pella**
Additional Writers — **Femi Balogun**, **Katarzyna Wrobel**
Dialogue & Hand-Off Barks *(PORTAL_BANTER)* — **Soren Dalgetty**
Grievance & Paperwork Copywriting *(Don K. Eggshell's Dialogue)* — **Marguerite Cho**
...
UI/UX Engineering — **Harriet Osei**
Mobile Platform Engineering *(iOS Install Gate, Service Worker)* — **Devraj Anand**
Safari Fullscreen API Denial Liaison — **Devraj Anand** *(still processing)*
Build Systems & Release Engineering — **Petra Lindqvist**
QA Automation & Fairness Simulation — **Wendell Bracks**

---

## ART

Art Director — **Ottoline Marsh**
Character & Toon Art *(Procedural Vector Cast)* — **Idris Vane**
Environment Art, Eight Visual Style Packs — **Beatrix Solheim**
Concept Art — **Julinho Cassiano**
Technical Art & Palette Systems — **Greta Osmundsen**
VFX, Relay Blast & Screen Clears — **Femke van der Ploeg**

**Animation**
Animation Director — **Casimir Dubuque**
Character Animation — **Yara Delacroix-Osei**

---

## AUDIO

Audio Director — **Nathaniel Aubuchon**
Composer, Original Chiptune Score — **Wilhelmina Sacks**
Sound Design — **Booker Lindholm**
Additional Music Programming — **Aksel Berg**

---

**[ RELAY HANDOFF: AUDIO → CAST ]**
AUDIO: *"Your turn."*
CAST: *"POYO."*
...
**Lorenzo "Wrenches" Bracciano** ................. performed by **"Big Sal" Marchetti**, Local 4, Certified
...
Marketing Director — **Louis Okonjo**
Community Management — **Priyanka Vats**
Social & Teaser Strategy — **Django Kessler**
Trailer Editor — **Saoirse Manwaring**

---

## BUSINESS

President & CEO, Circuit & Splice Interactive — **Cornelius P. Ashgrove III**
Chief Financial Officer *(Approved The Budget Cuts)* — **Yolanda Rask**
Board of Directors — **R. Okafor-Lindt**, **M. Bassignani**, **T. Achterberg**
Board Observer *(Non-Voting, Seat Disputed)* — **Don K. Eggshell, PhD**
...
To everyone who ever put a quarter in a machine that didn't need one.
To forty years of heroes who came before and went uncredited, on a technicality.
To whoever left the arcade unlocked.
To the person who found the receipt Fernwick calls sacred, and didn't throw it away.
To our families, our playtesters, and our community.
To the one door nobody has opened yet.
...
**Gary.**
Deceased since before this game began.
He asked that this be brief.
It is not.
...
Mild Cartoon Violence · Comic Bureaucracy · Sustained Appliance Peril
```

**A GENERAL APPLIANCE HOLDINGS RELEASE**

---

*(The LED blinks twice. THE SOCKET stays lit.)*

**DON K. EGGSHELL, PHD WILL RETURN IN: A GRIEVANCE, ITEMIZED.**

*A form is already being filed about this sequel.*
